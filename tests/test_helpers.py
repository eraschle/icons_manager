...
from icon_manager.helpers.path import (
    crawle_folder, is_file, is_file_extensions, get_files, get_path, get_paths,
    count_of, count_of_recursive, total_count
)
from icon_manager.helpers.string import (
    fixed_length, prefix_value, list_value, FILL_SPACE, FILL_HYPHEN, 
    ALIGN_LEFT, ALIGN_RIGHT, ALIGN_CENTRE
)
...
class TestPathHelpers:
    ...
    def test_get_paths_returns_list_of_joined_paths(self):
        ...
        expected = ['/test/path/file1.txt', '/test/path/file2.txt', '/test/path/file3.txt']
